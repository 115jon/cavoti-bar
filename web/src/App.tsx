...
export function App({ bridge }: AppProps) {
  ...
  useEffect(() => {
    ...
    return () => { unsubscribe(); window.removeEventListener("cavoti-refresh", refresh); };
  }, [bridge]);
