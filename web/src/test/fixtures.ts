...
export const liveSnapshot: SnapshotEnvelope = {
  ...
  subscriptions: [
    {
      ...
      usage: {
        fiveHour: {
          ...
          configured: true,
          unit: "points",
          resetAt: "2026-07-24T10:06:49.000Z",
        },
        daily: {
          used: 441.5,
          limit: 650,
        ...
        weekly: {
          ...
          configured: true,
          unit: "points",
          resetAt: "2026-07-29T23:05:48.000Z",
        },
        monthly: {
          used: 473.5,
          limit: 9000,
          configured: true,
          unit: "points",
          resetAt: "2026-08-22T23:05:48.000Z",
        },
      },
    },
  ],
  ...
  usageLogs: [],
  usagePageInfo: { page: 1, pageSize: 100, total: 0, pages: 1 },
  errors: [],
