...
export const liveSnapshot: SnapshotEnvelope = {
  ...
  subscriptions: [
    {
      ...
      usage: {
        fiveHour: { used: 441.5, limit: 650, configured: true, unit: "points", resetAt: "2026-07-24T10:06:49.000Z" },
        daily: { used: 441.5, limit: 650, configured: true, unit: "points", resetAt: "2026-07-24T10:06:49.000Z" },
        weekly: { used: 473.5, limit: 4000, configured: true, unit: "points", resetAt: "2026-07-29T23:05:48.000Z" },
        monthly: { used: 473.5, limit: 9000, configured: true, unit: "points", resetAt: "2026-08-22T23:05:48.000Z" },
      },
    },
  ],
  stats: {
  ...
  apiKeys: [{ id: 1, name: "Primary key" }],
  groupOptions: [{ id: 23, name: "GPT Team" }],
};
